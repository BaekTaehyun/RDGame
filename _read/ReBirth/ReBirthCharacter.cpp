...
AReBirthCharacter::AReBirthCharacter() {
  ...
  // Create the Hero Component for input handling
  HeroComponent =
      CreateDefaultSubobject<UReBirthHeroComponent>(TEXT("HeroComponent"));
...
void AReBirthCharacter::SetupPlayerInputComponent(
  ...
  if (UEnhancedInputComponent *EnhancedInputComponent =
    ...
    EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered,
                                       this, &AReBirthCharacter::Move);
    EnhancedInputComponent->BindAction(MouseLookAction,
                                       ETriggerEvent::Triggered, this,
                                       &AReBirthCharacter::Look);

    // Looking
    EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered,
                                       this, &AReBirthCharacter::Look);
  } else {
    UE_LOG(
        LogReBirth, Error,
...
void AReBirthCharacter::Move(const FInputActionValue &Value) {
  // input is a Vector2D
...
void AReBirthCharacter::Look(const FInputActionValue &Value) {
  // input is a Vector2D
...
void AReBirthCharacter::DoMove(float Right, float Forward) {
...
void AReBirthCharacter::DoLook(float Yaw, float Pitch) {
  if (GetController() != nullptr) {
...
void AReBirthCharacter::DoJumpStart() {
  // signal the character to jump
  Jump();
}

void AReBirthCharacter::DoJumpEnd() {

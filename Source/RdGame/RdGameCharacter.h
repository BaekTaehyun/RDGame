...
#include "RdGameCharacter.generated.h"
 ...
 */
UCLASS(abstract)
class ARdGameCharacter : public ACharacter,
...
public:
  /** Constructor */
  ARdGameCharacter();
  ARdGameCharacter(const FObjectInitializer &ObjectInitializer);
...
public:
  ...
  /** Performs the attack's collision check. Usually called from a montage's
   * AnimNotify */

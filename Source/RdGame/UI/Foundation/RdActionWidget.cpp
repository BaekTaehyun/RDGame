...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RdActionWidget)

FSlateBrush URdActionWidget::GetIcon() const
{
...
UEnhancedInputLocalPlayerSubsystem* URdActionWidget::GetEnhancedInputSubsystem() const
{

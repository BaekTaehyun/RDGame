...
#include "RdMaterialProgressBar.generated.h"
...
/**
 * URdMaterialProgressBar
 *
 * Material-based progress bar widget with animation and customization support.
 */
UCLASS(Abstract, meta = (DisableNativeTick))
class RDGAME_API URdMaterialProgressBar : public UCommonUserWidget
{
	GENERATED_BODY()

...
#include "RdMaterialProgressBar.h"

#include "Animation/WidgetAnimation.h"
#include "Components/Image.h"
#include "Materials/MaterialInstanceDynamic.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RdMaterialProgressBar)

void URdMaterialProgressBar::SynchronizeProperties()
{
...
#if WITH_EDITOR
void URdMaterialProgressBar::OnWidgetRebuilt()
{
...
void URdMaterialProgressBar::OnAnimationFinished_Implementation(const UWidgetAnimation* Animation)
{
...
void URdMaterialProgressBar::SetProgress(float Progress)
{
...
void URdMaterialProgressBar::SetStartProgress(float StartProgress)
{
...
void URdMaterialProgressBar::SetColorA(FLinearColor ColorA)
{
...
void URdMaterialProgressBar::SetColorB(FLinearColor ColorB)
{
...
void URdMaterialProgressBar::SetColorBackground(FLinearColor ColorBackground)
{
...
void URdMaterialProgressBar::AnimateProgressFromStart(float Start, float End, float AnimSpeed)
{
...
void URdMaterialProgressBar::AnimateProgressFromCurrent(float End, float AnimSpeed)
{
	if (UMaterialInstanceDynamic* MID = GetBarDynamicMaterial())
	{
...
void URdMaterialProgressBar::SetProgress_Internal(float Progress)
{
	if (UMaterialInstanceDynamic* MID = GetBarDynamicMaterial())
	{
...
void URdMaterialProgressBar::SetStartProgress_Internal(float StartProgress)
{
	if (UMaterialInstanceDynamic* MID = GetBarDynamicMaterial())
	{
...
void URdMaterialProgressBar::SetColorA_Internal(FLinearColor ColorA)
{
	if (UMaterialInstanceDynamic* MID = GetBarDynamicMaterial())
	{
		CachedColorA = ColorA;
...
void URdMaterialProgressBar::SetColorB_Internal(FLinearColor ColorB)
{
	if (UMaterialInstanceDynamic* MID = GetBarDynamicMaterial())
	{
		CachedColorB = ColorB;
...
void URdMaterialProgressBar::SetColorBackground_Internal(FLinearColor ColorBackground)
{
	if (UMaterialInstanceDynamic* MID = GetBarDynamicMaterial())
	{
...
UMaterialInstanceDynamic* URdMaterialProgressBar::GetBarDynamicMaterial() const
{
	if (!CachedMID)
	{

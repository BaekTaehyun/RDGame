...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RdHUDLayout)
...
void URdHUDLayout::NativeDestruct()
{
...
void URdHUDLayout::HandleInputDeviceConnectionChanged(EInputDeviceConnectionState NewConnectionState, FPlatformUserId PlatformUserId, FInputDeviceId InputDeviceId)
{
...
void URdHUDLayout::HandleInputDevicePairingChanged(FInputDeviceId InputDeviceId, FPlatformUserId NewUserPlatformId, FPlatformUserId OldUserPlatformId)
{
	const FPlatformUserId OwningLocalPlayerId = GetOwningLocalPlayer()->GetPlatformUserId();
...
bool URdHUDLayout::ShouldPlatformDisplayControllerDisconnectScreen() const
{
...
void URdHUDLayout::NotifyControllerStateChangeForDisconnectScreen()
{
...
void URdHUDLayout::ProcessControllerDevicesHavingChangedForDisconnectScreen()
{
	// We should only ever get here if we have bound to the controller state change delegates
	ensure(ShouldPlatformDisplayControllerDisconnectScreen());
...
void URdHUDLayout::DisplayControllerDisconnectedMenu_Implementation()
{
...
void URdHUDLayout::HideControllerDisconnectedMenu_Implementation()
{

...
#include "RdWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RdWidgetFactory_Class)

TSubclassOf<UUserWidget> URdWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{

...
FDungeonGrid UDungeonBuilder::BuildDungeon(const FDungeonGenConfig& Config, UObject* Outer)
{
    FDungeonGrid Grid;
    ...
    if (Algo)
    {
        ...
        UE_LOG(LogTemp, Log, TEXT("UDungeonBuilder: Generated dungeon of size %dx%d using Seed %d"), 
            Config.Width, Config.Height, Config.Seed);
    }
    else
    {
        UE_LOG(LogTemp, Warning, TEXT("UDungeonBuilder: Failed to create algorithm instance."));
    }

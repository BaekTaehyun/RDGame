...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Generation", meta=(EditCondition="Algorithm == EDungeonAlgorithmType::BSP"))
	int32 MinRoomSize = 6;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "System", meta=(EditCondition="bUseChunking"))
	int32 ChunkSize = 10;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "System")
	bool bEnableStreaming = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "System", meta=(EditCondition="bEnableStreaming"))
